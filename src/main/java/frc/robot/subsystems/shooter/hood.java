...
public class hood extends SubsystemBase {
    ...
    public hood(CANBus cn) {
        ...
        limit = new CANdi(HoodConstants.LIMIT_SWITCH_ID, cn);
    ...
    public void config(){
        ...
        b.SensorToMechanismRatio = HoodConstants.GEAR_RATIO;
    ...
    public void hoodSpeed(double speed){
        ...
        if(hoodMotor.getPosition().getValueAsDouble() >= HoodConstants.UPPER_LIMIT && speed >0){
            hoodMotor.setControl(dutyCycl.withOutput(0));
        }else if(hoodMotor.getPosition().getValueAsDouble() <= HoodConstants.LOWER_LIMIT && speed <0){
            hoodMotor.setControl(dutyCycl.withOutput(0));
        }else{
