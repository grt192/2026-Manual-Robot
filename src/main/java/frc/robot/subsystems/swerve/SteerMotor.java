...
public class SteerMotor extends SubsystemBase{
    ...
    private void configureMotor() {
        ...
        motorConfig.TorqueCurrent.PeakForwardTorqueCurrent = STEER_STATOR_CURRENT_LIMIT;
        motorConfig.TorqueCurrent.PeakReverseTorqueCurrent = -STEER_STATOR_CURRENT_LIMIT;
